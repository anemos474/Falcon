...
export declare const GET_IS_AUTHENTICATED: import("@apollo/client").DocumentNode;
export declare type IsAuthenticatedResponse = {
    customer: Pick<Customer, 'id'>;
};
export declare class IsAuthenticatedQuery extends Query<IsAuthenticatedResponse> {
    static defaultProps: {
...
//# sourceMappingURL=IsAuthenticatedQuery.d.ts.map