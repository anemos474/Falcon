...
export declare const Textarea: <TAsTag extends string | {} = "textarea">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<{
        rows: number;
        invalid: boolean;
    }>;
} & Partial<import("react").ClassAttributes<HTMLTextAreaElement> & import("react").TextareaHTMLAttributes<HTMLTextAreaElement> & {
    rows: number;
    invalid: boolean;
