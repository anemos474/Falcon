...
declare type CheckboxInnerDOMProps = React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> & {
    invalid: boolean;
    icon: JSX.Element;
};
export declare const Checkbox: <TAsTag extends string | {} = (props: CheckboxInnerDOMProps) => JSX.Element>(props: React.PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<{
        invalid: boolean;
        icon: JSX.Element;
    }>;
} & Partial<Partial<CheckboxInnerDOMProps> & {
    invalid: boolean;
    icon: JSX.Element;
