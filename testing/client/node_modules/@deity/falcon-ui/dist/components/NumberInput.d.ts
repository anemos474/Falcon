...
declare type NumberInputInnerDOMProps = {
    invalid?: boolean;
    increaseText?: string;
    decreaseText?: string;
    step?: number;
...
declare class NumberInputInnerDOM extends React.Component<NumberInputInnerDOMProps> {
    inputRef: HTMLInputElement | undefined;
    onChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
    mountInputRef: (el: HTMLInputElement) => void;
    stepUp: () => void;
    stepDown: () => void;
    canIncrease(): boolean;
    canDecrease(): boolean;
...
export declare const NumberInput: <TAsTag extends string | {} = typeof NumberInputInnerDOM>(props: React.PropsWithChildren<{
    as?: TAsTag;
...
} & Partial<Partial<NumberInputInnerDOMProps> & {
    invalid: boolean;
    min: number;
    max: number;
    step: number;
