...
export declare type BreadcrumbsProps = Parameters<typeof Breadcrumbs>[0];
export declare const Breadcrumbs: <TAsTag extends string | {} = "ul">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
...
export declare type BreadcrumbProps = Parameters<typeof Breadcrumb>[0];
export declare const Breadcrumb: <TAsTag extends string | {} = "li">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
