...
export declare type RadioProps = React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> & {
    icon: JSX.Element;
    invalid: boolean;
};
export declare const Radio: <TAsTag extends string | {} = (props: RadioProps) => JSX.Element>(props: React.PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<{
        invalid: boolean;
        icon: JSX.Element;
    }>;
} & Partial<Partial<RadioProps> & {
    invalid: boolean;
    icon: JSX.Element;
