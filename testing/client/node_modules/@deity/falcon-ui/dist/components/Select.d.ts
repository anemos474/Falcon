...
export declare const Select: <TAsTag extends string | {} = "select">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<{
        invalid: boolean;
    }>;
} & Partial<import("react").ClassAttributes<HTMLSelectElement> & import("react").SelectHTMLAttributes<HTMLSelectElement> & {
    invalid: boolean;
...
export declare const Option: <TAsTag extends string | {} = "option">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
} & Partial<import("react").DetailedHTMLProps<import("react").OptionHTMLAttributes<HTMLOptionElement>, HTMLOptionElement>> & import("../theme").BaseThemingProps & import("../theme").BreakpointBlockThemingProps & {
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
    variant?: string;
