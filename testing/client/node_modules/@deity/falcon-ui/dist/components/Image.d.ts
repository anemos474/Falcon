...
export declare type ImageProps = Parameters<typeof Image>[0];
export declare const Image: <TAsTag extends string | {} = "img">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
} & Partial<import("react").DetailedHTMLProps<import("react").ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>> & import("../theme").BaseThemingProps & import("../theme").BreakpointBlockThemingProps & {
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
    variant?: string;
