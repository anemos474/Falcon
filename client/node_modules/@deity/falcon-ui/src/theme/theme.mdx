...
You can see all theme default values specified in [source code](https://github.com/deity-io/falcon-platform/blob/master/packages/falcon-ui/src/theme/theme.ts), or
