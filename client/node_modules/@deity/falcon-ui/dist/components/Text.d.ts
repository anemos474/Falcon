...
export declare type TextProps = Parameters<typeof Text>[0];
export declare const Text: <TAsTag extends string | {} = "p">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<{
        ellipsis: boolean;
    }>;
} & Partial<import("react").ClassAttributes<HTMLParagraphElement> & import("react").HTMLAttributes<HTMLParagraphElement> & {
    ellipsis: boolean;
