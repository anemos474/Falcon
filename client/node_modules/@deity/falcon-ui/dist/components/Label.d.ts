...
export declare const Label: <TAsTag extends string | {} = "label">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
} & Partial<import("react").DetailedHTMLProps<import("react").LabelHTMLAttributes<HTMLLabelElement>, HTMLLabelElement>> & import("../theme").BaseThemingProps & import("../theme").BreakpointBlockThemingProps & {
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
    variant?: string;
