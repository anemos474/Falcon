...
export declare const Link: <TAsTag extends string | {} = "a">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
} & Partial<import("react").DetailedHTMLProps<import("react").AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>> & import("../theme").BaseThemingProps & import("../theme").BreakpointBlockThemingProps & {
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
    variant?: string;
