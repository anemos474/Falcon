...
export declare const RangeInput: <TAsTag extends string | {} = "input">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<{
        type: string;
    }>;
} & Partial<import("react").ClassAttributes<HTMLInputElement> & import("react").InputHTMLAttributes<HTMLInputElement> & {
    type: string;
