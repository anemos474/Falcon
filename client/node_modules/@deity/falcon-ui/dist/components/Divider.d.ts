...
export declare const Divider: <TAsTag extends string | {} = "hr">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
} & Partial<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLHRElement>, HTMLHRElement>> & import("../theme").BaseThemingProps & import("../theme").BreakpointBlockThemingProps & {
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
    variant?: string;
