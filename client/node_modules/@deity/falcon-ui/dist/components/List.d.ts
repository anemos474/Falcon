...
export declare type ListProps = Parameters<typeof List>[0];
export declare const List: <TAsTag extends string | {} = "ul">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
...
export declare const ListItem: <TAsTag extends string | {} = "li">(props: import("react").PropsWithChildren<{
    as?: TAsTag;
    defaultTheme?: import("../theme").DefaultTheme<unknown>;
